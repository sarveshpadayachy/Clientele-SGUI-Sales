...
public class StandardLegalIndividual extends PageObject {
    ...
    String PayerXpath = "/html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[4]/div[2]";
    ...
    String NavigateMemberPage = "/html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[2]/div[1]";
    ...
    String FICAXpath = "/html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[5]/div[2]";

    String PremiumXpath = "/html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[6]/div[2]";

    String RewardsXpath = "/html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[7]/div[2]";
    ...
    String GovernmentQ1 = "//*[@id=\"bootstrap-table\"]/tbody/tr[1]/td[3]/input";
    String GovernmentQ2 = "//*[@id=\"bootstrap-table\"]/tbody/tr[2]/td[3]/input";
    String GovernmentQ3 = "//*[@id=\"bootstrap-table\"]/tbody/tr[3]/td[3]/input";
    String Government4 = "//*[@id=\"bootstrap-table\"]/tbody/tr[4]/td[3]/input";
    String GovernmentQ5 = "//*[@id=\"bootstrap-table\"]/tbody/tr[5]/td[3]/input";
    String GovernmentQ6 = "//*[@id=\"bootstrap-table\"]/tbody/tr[6]/td[3]/input";
    String GovernmentQ7 = "//*[@id=\"bootstrap-table\"]/tbody/tr[7]/td[3]/input";
    String SaveBtnS = "//button[normalize-space()='Save']";
...
//        }
    ...
    public void SelectPlanOptionII() throws InterruptedException {
        Thread.sleep(5000);
...
//        sliderPointer.click();
// R10 000 (//div[@class='ngx-slider-inner-tooltip ng-star-inserted'])[2]
// "//span[@aria-label='ngx-slider']"
        // //span[3]//ngx-slider-tooltip-wrapper[1]//div[1]
        // 15 000 "(//div[@class='ngx-slider-inner-tooltip ng-star-inserted'])[3]"
    }
    ...
    public void NavExtMemberPageB() throws InterruptedException {
        Thread.sleep(6000);
        $(By.xpath(NavigateMemberPage)).click();
    }

    @Step("Add a Extended Member  ")
    public void addExtFamilyB() throws InterruptedException {
        Thread.sleep(5000);
    ...
    public void ExtendedTitleB(String ExtMemberTitleB) {
        WebElement Ex = $(By.xpath(ExtTitle));
        selectFromDropdown(Ex, ExtMemberTitleB);

    }

    @Step("Enter Extended member name")
    public void ExtMemNameB(String ExtMmemberNameB) {
        $(By.xpath(ExtName)).sendKeys(ExtMmemberNameB);
    }


    @Step("enter Extended member surname")
    public void ExtMemSurnameB(String ExtMmemberSurnameB) {
        $(By.xpath(ExtSurname)).sendKeys(ExtMmemberSurnameB);
    }


    @Step("select Extended member gender")
    public void SelectExtendedmemberGenderB(String ExtMmemberGenderB) {
        Select product = new Select(getDriver().findElement(By.xpath(ExtGender)));
        product.selectByValue(ExtMmemberGenderB);


    }

    @Step("Enter ExtMmemberID number")
    public void ExtMmemberIDNumberB(String ExtMmemberIDNumberB) {
        $(By.xpath(ExtIdNumber)).sendKeys(ExtMmemberIDNumberB);
    }


    @Step("Save Member ")
    public void SaveMemberB() throws InterruptedException {
        Thread.sleep(2000);
        $(By.xpath(SaveMember)).click();
    }

    @Step("select Extended member Relationship")
    public void SelectExtendedmemberRelationshipB(String ExtMmemberRelationship) {
