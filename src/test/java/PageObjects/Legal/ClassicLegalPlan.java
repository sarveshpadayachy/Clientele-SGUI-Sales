...
public class ClassicLegalPlan extends PageObject {
    ...
    ///html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[3]/div[2]";
    ...
    String saveChildBtn = "(//button[@type='button'])[1]";
...
// AllXpath
    ...
    public void SelectPlanOptionII(String PlanOP1) throws InterruptedException {
        Thread.sleep(5000);

        WebElement dropdownOp = $(By.xpath(PlanOptionXpath));
        Select selectObject = new Select(dropdownOp);
        selectObject.selectByVisibleText(PlanOP1);
...
// "//span[@aria-label='ngx-slider']"
    ...
    public void SpouseIDNumber(String SpouseIDNumber) {
        $(By.xpath(IDNumberXpath)).sendKeys(SpouseIDNumber);
    }
    ...
    public void addExtFamily() throws InterruptedException {
        Thread.sleep(5000);
