...
public class EnhancedExtendedLegalIndividual extends PageObject {
...
// AllXpath
    ...
    public void SelectPlanOptionIII(String PlanOP) throws InterruptedException {
        Thread.sleep(5000);

        WebElement dropdownOp = $(By.xpath(PlanOptionXpath));
        Select selectObject = new Select(dropdownOp);
        selectObject.selectByVisibleText(PlanOP);
...
//        selectObject.selectByValue(PayerTitle);
    ...
    public void selectCoverAmountI() throws InterruptedException {
        Thread.sleep(7000);
...
//
//    @Step("Navigate Extended Member page")
//    public void NavExtMemberPage()  {
//        WebDriverWait wait = new WebDriverWait(getDriver(),Duration.ofSeconds(5));
//        WebElement Em = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(NavigateMemberPage)));
//        Em.click();
//    }
//
//
//    @Step("Add a Extended Member page ")
//    public void addExtFamily()  {
//        WebDriverWait wait = new WebDriverWait(getDriver(),Duration.ofSeconds(5));
//        WebElement Ex = $(By.xpath("/html/body/shamba-root/shamba-layout/div/div[2]/sale/div/div[2]/div/app-sale-capture/div/div/div/div/div[2]/sale-capture-control/div/div[1]/div/ul/li[5]/div[2]"));
//                Ex.click();
//    }
//
//
    ...
    public void PremiumFee(String PreFee) {
        WebElement dropdown = $(By.xpath(PremiumFeeXpath));
        Select selectObject = new Select(dropdown);
        selectObject.selectByValue(PreFee);
    ...
    @Step("Add a Extended Member  ")
    public void addExtFamilyA() throws InterruptedException {
        Thread.sleep(5000);
        $(By.xpath(AddExtFamily)).click();
    }

    @Step("Select the Extended member  title")
    public void ExtendedTitleA(String ExtMemberTitleA) {
        WebElement Ex = $(By.xpath(ExtTitle));
        selectFromDropdown(Ex, ExtMemberTitleA);

    }

    @Step("Enter Extended member name")
    public void ExtMemNameA(String ExtMmemberNameA) {
        $(By.xpath(ExtName)).sendKeys(ExtMmemberNameA);
    }


    @Step("enter Extended member surname")
    public void ExtMemSurnameA(String ExtMmemberSurnameA) {
        $(By.xpath(ExtSurname)).sendKeys(ExtMmemberSurnameA);
    }


    @Step("select Extended member gender")
    public void SelectExtendedmemberGenderA(String ExtMmemberGenderA) {
        Select product = new Select(getDriver().findElement(By.xpath(ExtGender)));
        product.selectByValue(ExtMmemberGenderA);


    }

    @Step("Enter ExtMmemberID number")
    public void ExtMmemberIDNumberA(String ExtMmemberIDNumberA) {
        $(By.xpath(ExtIdNumber)).sendKeys(ExtMmemberIDNumberA);
    }


    @Step("Save Member ")
    public void SaveMemberA() throws InterruptedException {
        Thread.sleep(3000);
        $(By.xpath(SaveMember)).click();
    }

    @Step("select Extended member Relationship")
    public void SelectExtendedmemberRelationshipA(String ExtMmemberRelationshipA) {
        Select product = new Select(getDriver().findElement(By.xpath(ExtRelationship)));
        product.selectByValue(ExtMmemberRelationshipA);
    }

    @Step("Select premium fee")
    public void PremiumFeeA(String PreFeeA) {
        WebElement dropdown = $(By.xpath(PremiumFeeXpath));
        Select selectObject = new Select(dropdown);
        selectObject.selectByValue(PreFeeA);
    }
