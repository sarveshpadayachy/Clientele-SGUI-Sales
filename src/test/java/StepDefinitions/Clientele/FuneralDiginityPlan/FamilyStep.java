package StepDefinitions.Clientele.FuneralDiginityPlan;

import PageObjects.Clientele.FuneralDignityPlan.Family;
...
public class FamilyStep extends PageObject {
    ...
    public void userLogInWithValidCredentialsByEntering() throws InterruptedException {
        ...
        family.PopUpLogin("Spadayachy", "Spider_Man_2024");
        family.LoginButton();
